...
1. [技术原理：PureBasic 调试协议](#1-技术原理purebasic-调试协议)
2. [架构设计](#2-架构设计)
3. [文件结构](#3-文件结构)
4. [配置说明](#4-配置说明)
5. [核心实现要点](#5-核心实现要点)
...
| **竞态条件**：被调试程序启动后可能在调试器连接通道之前就尝试连接 | 中 | 必须先创建/监听通道，然后启动程序（参见 5.1） |
